...
const FLM = () => {
  ...
  const handleDelete = async (e) => {
    e.preventDefault();
    try {
      const response = await MainServices.delete(deleteIndex.id);
      ...
      closeDeleteModal(); // Close modal after successful
      fetch();
    } catch (error) {
      setNotification("Gagal Menghapus Data");
    }
  };
